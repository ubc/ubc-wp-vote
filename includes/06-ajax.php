...
function ubc_ctlt_wp_vote_upvote() {
	...
	if ( false === $success ) {
		wp_die( esc_html( 'Error in \'ubc_ctlt_wp_vote_upvote\': \'do_current_user_up_vote\' return false. Object ID ' . $object_id . ', Object Type: ' . $object_type . '.' ), 'Error', array( 'response' => 400 ) );
	}
...
function ubc_ctlt_wp_vote_downvote() {
	...
	if ( false === $success ) {
		wp_die( esc_html( 'Error in \'ubc_ctlt_wp_vote_downvote\': \'do_current_user_down_vote\' return false. Object ID ' . $object_id . ', Object Type: ' . $object_type . '.' ), 'Error', array( 'response' => 400 ) );
	}
...
function ubc_ctlt_wp_vote_rating() {
	...
	if ( false === $success ) {
		wp_die( esc_html( 'Error in \'ubc_ctlt_wp_vote_rating\': \'do_current_user_rating\' return false. Object ID ' . $object_id . ', Object Type: ' . $object_type . '.' ), 'Error', array( 'response' => 400 ) );
	}
